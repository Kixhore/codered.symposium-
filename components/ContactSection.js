              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">symposium@lits.edu.in</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-[var(--glass-border)] text-center">
                ...
                <div className="flex gap-4 justify-center">
                  {['twitter', 'linkedin', 'instagram', 'facebook'].map((social) => (
                    <button key={social} className="w-10 h-10 rounded-lg bg-white bg-opacity-10 flex items-center justify-center hover:bg-white hover:bg-opacity-20 transition-all duration-300">
                      <div className={`icon-${social} text-lg text-[var(--neon-red)]`}></div>
                    </button>
                  ))}
                </div>
              </div>
